...
@mock.patch(
    "kolibri.plugins.edulution.kolibri_plugin.DiscoveryHookMixin._learner_ids",
    return_value=["abc123"],
)
class NetworkDiscoveryForSoUDHookTestCase(TestCase):
    def setUp(self):
        ...
        self.hook = NetworkLocationDiscoveryHook.get_hook(
            "kolibri.plugins.edulution.NetworkDiscoveryForSoUDHook"
        )
        ...
        get_setting_patcher = mock.patch(
            "kolibri.plugins.edulution.kolibri_plugin.get_device_setting"
        )
