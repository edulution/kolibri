<template>
  <div
    ...
    :class="{ 'mobile-thumbnail': isMobile, 'card-thumbnail-wrapper-fullwidth': fullwidth }"
    :style="thumbnailBackground"
  >

    <div class="content-icon-wrapper">
      <svg height="64" width="64" viewBox="0 0 64 64" class="content-icon-bg">
        <polygon stroke-width="0" points="0,0 64,0 0,64" />
      </svg>

      <ContentIcon kind="channel" class="content-icon" color="white" />
    </div>

    <div class="progress-bar-wrapper" :style="{ backgroundColor: $themePalette.grey.v_200 }">
      <div
        class="progress-bar"
        :style="{
          width: percent + '%',
...
.card-thumbnail-wrapper {
  ...
  &.card-thumbnail-wrapper-fullwidth {
    width: 100% !important;
  }
}
