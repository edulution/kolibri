...
export const PageNames = {
  ...
  REPORTS_GROUP_REPORT_ASSESSMENT_LEARNER_PAGE_ROOT : 'REPORTS_GROUP_REPORT_ASSESSMENT_LEARNER_PAGE_ROOT',
  REPORTS_ASSESSMENT_LEARNER_PAGE_ROOT: 'REPORTS_ASSESSMENT_LEARNER_PAGE_ROOT',
  ASSESSMENT_CREATION_ROOT: 'ASSESSMENT_CREATION_ROOT',
  ASSESSMENT_CREATION_PRACTICE_QUIZ: 'ASSESSMENT_CREATION_PRACTICE_QUIZ',
  ASSESSMENT_CREATION_SELECT_PRACTICE_QUIZ_TOPIC: 'ASSESSMENT_CREATION_SELECT_PRACTICE_QUIZ_TOPIC',
  ASSESSMENT_CREATION_TOPIC: 'ASSESSMENT_CREATION_TOPIC',
  ASSESSMENT_CREATION_BOOKMARKS: 'ASSESSMENT_CREATION_BOOKMARKS',
  ASSESSMENT_CREATION_BOOKMARKS_MAIN: 'ASSESSMENT_CREATION_BOOKMARKS_MAIN',
  ASSESSMENT_CREATION_SEARCH: 'ASSESSMENT_CREATION_SEARCH',
  ASSESSMENT_CREATION_QUESTION_SELECTION: 'ASSESSMENT_CREATION_QUESTION_SELECTION',
  ASSESSMENT_CREATION_PRACTICE_QUIZ_PREVIEW: 'ASSESSMENT_CREATION_PRACTICE_QUIZ_PREVIEW',
  ASSESSMENT_CREATION_PREVIEW: 'ASSESSMENT_CREATION_PREVIEW',
  ASSESSMENT_QUIZ_SUMMARY: 'ASSESSMENT_QUIZ_SUMMARY',
  ASSESSMENT_CREATION_CONFIRM: 'ASSESSMENT_CREATION_CONFIRM',
  ASSESSMENT_TEST_SUMMARY: 'ASSESSMENT_TEST_SUMMARY',
};
