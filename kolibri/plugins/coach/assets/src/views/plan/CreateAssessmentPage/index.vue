...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      bookmarksRoute() {
        return (
          this.pageName === PageNames.ASSESSMENT_CREATION_BOOKMARKS_MAIN ||
          this.pageName === PageNames.ASSESSMENT_CREATION_BOOKMARKS
        );
      },
      examCreationRoute() {
      ...
      examTopicRoute() {
        return this.pageName === PageNames.ASSESSMENT_CREATION_TOPIC;
      },
    ...
    methods: {
      ...
      continueProcess() {
        if (this.selectionIsInvalidText) {
          ...
          this.$router.push({ name: PageNames.ASSESSMENT_CREATION_QUESTION_SELECTION });
        }
      },
