...
class ExerciseDifficultQuestionTestCase(APITestCase):
    def setUp(self):
        ...
        self.exercise_difficulties_basename = (
            "kolibri:kolibri.plugins.edulutionCoach:exercisedifficulties"
        )
...
class QuizDifficultQuestionTestCase(APITestCase):
    def setUp(self):
        ...
        self.quiz_difficulties_basename = (
            "kolibri:kolibri.plugins.edulutionCoach:quizdifficulties"
        )
...
class PracticeQuizDifficultQuestionTestCase(APITestCase):
    def setUp(self):
        ...
        self.exercise_difficulties_basename = (
            "kolibri:kolibri.plugins.edulutionCoach:practicequizdifficulties"
        )
